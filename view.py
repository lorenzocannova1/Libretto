...
class View:
    ...
    def loadInterface(self):
        ...
        row1 = ft.Row([self._titolo], alignment=MainAxisAlignment.CENTER)
        row2 = ft.Row([self._student],alignment=MainAxisAlignment.END)
        ...
        self._txtInNome = ft.TextField(label="Nome esame",
                                       hint_text="Inserisci il nome dell'esame",width=300)
        ...
        row3 = ft.Row(controls=[self._txtInNome, self._ddVoto, self._btnCal,
